...
input_folder = r'data/ignored_data/aux_ais_data/2012_ais'
output_folder = r'data/ais_data/2012_ais'
    ...
    for file in files:
        if file.endswith('.csv'):
            ...
            if 'name' in df.columns:
                df['name'] = df['name'].str.replace('MV ZAANDAM', 'ZAANDAM')
                df['name'] = df['name'].str.replace('MV ZUIDERDAM', 'ZUIDERDAM')
